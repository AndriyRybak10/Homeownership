...
function changeLanguageEng() {
   let engTexts = [
      "Agents", "Homebuyers", "Resources", "Log In", "Sign up now" ,"Providing certainty on the journey to homeownership.",
      "Guarantee your home closes with cash-backed, contingency-free offers for buyers, sellers, their agents, and loan officers.","Sign up now",
      "Learn more", "FEATURED IN", "Who we empower", "BuyEr's AgentS", "Buyers", "Listing agents", "sellers", "Loan officers", "BuyER's agents","Give your buyers the certainty of cash",
      ...
      "Get Certified Today", "Keep Your Commission", "Write More Winning Offers", "Guaranteed to Close", "You’re in good company",
      ...
      "Edgar Gonzalez", "eXp Realty", "Agents love us because we empower their buyers with cash and don't compete for their commissions.",
      "Learn More", "7,000+", "30,000+", "$5 B+", "Homes Purchased", "Agents", "Buying Power", "Our solutions", "Turn an offer to all cash", "Buy before you sell",
      "Save an existing deal", "ORLANDO, FL", "home won with", "The buyer", "The seller", "won her dream house in multiple-offers situation.",
      "got a guaranteed closing with no contingencies.","Turn an offer to all cash", "Once your buyer is preapproved, upgrade your buying power to cash to make your strongest offer, first.",
      "Learn more", "Read the success story", "Everything you need is only a tap away", "Ribbon let’s you write an offer anytime, anywhere — right from your mobile device.",
      "agents",
      "Buying",
      "Listing",
      "iOS App",
